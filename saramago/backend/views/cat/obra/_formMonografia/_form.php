...
/* @var $model common\models\monografia */
...
<div class="obra-form">
    ...
    <?= $form->field($model, 'tipoObra')->hiddenInput(['value'=> 'monografia'])->label(false) ?>
    ...
    <?= $form->field($model, 'isbn')->textInput(['maxlength' => true, 'pattern'=>'[0-9]{10}|[0-9]{13}'])?>
