...
CREATE TABLE IF NOT EXISTS `yii2saramago`.`Cdu` (
  `id` INT NOT NULL,
  `codCdu` VARCHAR(255) NULL,
  `designacao` MEDIUMTEXT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `yii2saramago`.`Obra` (
  ...
  `assuntos` VARCHAR(255) NULL,
  `preco` VARCHAR(45) NULL,
  `frequencia` VARCHAR(45) NULL,
  `imgCapa` VARCHAR(45) NULL,
...
CREATE TABLE IF NOT EXISTS `yii2saramago`.`Fundo` (
  ...
  `tipo` ENUM('monografia', 'pubPeriodica', 'materialAv') NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `yii2saramago`.`TipoExemplar` (
  `id` INT NOT NULL,
  `designacao` MEDIUMTEXT NULL,
  `TipoExemplarcol` VARCHAR(45) NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `yii2saramago`.`Leitor` (
  ...
  `dataAtualizacao` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
  `Biblioteca_id` INT NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `yii2saramago`.`Reserva` (
  ...
  `estadoReserva` ENUM('reservado', 'cancelado', 'concluido') NULL DEFAULT 'reservado',
  `dataFecho` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS `yii2saramago`.`TipoLeitor` (
  `id` INT NOT NULL,
  `estatuto` VARCHAR(45) NULL,
  `tipo` ENUM('aluno', 'funcionário', 'externo') NULL,
...
CREATE TABLE IF NOT EXISTS `yii2saramago`.`TipoIrregularidade` (
  `id` INT NOT NULL,
  `irregularidade` ENUM('monografia', 'pubPeriodica', 'materialAV') NULL,
  `dias` INT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `yii2saramago`.`Irregularidade` (
  `id` INT NOT NULL,
  `dataInicial` DATETIME NULL DEFAULT CURRENT_TIMESTAMP,
